#!/bin/bash
# from https://github.com/ColorfulSS/docker-ubuntu-gnome-nomachine/blob/master/2-remote-virtual-desktops/nx/ubuntu-20.04-gnome-nomachine/GeForce-XorgDisplaySettingAuto.sh
# TODO 改改
